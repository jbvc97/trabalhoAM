...
var SpriteSheet = Class.extend(function() {
  ...
  this.load = function(spriteSheetImage, spriteSheetJSON, callback) {
    ...
    img.onload = function() {
      this.img = img;
      assetLoaded(); // a imagem foi carregada
    }.bind(this);
  ...
  this.parseSpriteSheetDefinition = function(atlasJSON) {
    ...
    assetLoaded(); // assinalar que os sprites forma extraídos
  };
